		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#wizardwizardui-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"wizardwizardui-display": {
								"semanticObject": "wizardwizardui",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=wizard.wizardui",
									"url": sap.ui.require.toUrl("wizard/wizardui")
								}
							}
						}
					}
